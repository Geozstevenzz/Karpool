...
const trip = { id: 2, name: 'Hamza Ahmad', vehicle: 'Sedan', capacity: 4, stops: 3, time: '11:00 AM', date: '26 Oct', distance: 300 , price: 400 }
...
const ConfirmScreen: React.FC = () => {
    ...
    useEffect(() => {
        const fetchRoute = async () => {
          const origin = [74.316979, 31.444957]; 
          const destination = [74.304131, 31.481403]; 
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.driverInfo}>
        <Pressable onPress={() => alert('Profile Pressed')}>
          <View style={styles.profileSection}>
            <Text style={styles.driverName}>{trip.name}</Text>
      ...
      <View style={styles.carInfo}>
        <View>
          <Text style={styles.carModel}>{trip.vehicle}</Text>
          <Text style={styles.carNumber}>LEA 3424</Text>
          <Text style={styles.carColor}>White</Text>
        </View>
        <Image
      ...
      <View style={styles.passengerStops}>
        ...
        <Pressable onPress={() => alert('Stops Pressed')}>
          <View style={styles.stopsSection}>
            ...
            <Text style={styles.stopsValue}>{trip.stops} &gt;</Text>
          </View>
        </Pressable>
      </View>
